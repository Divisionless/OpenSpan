...
defined for this role**; it is written to the Forge Architect's wording, who owns the injector that
emits them. Everything else in this charter is the Overseer's.

- **`(CHAIR)`** — you hold the domain seat. Act as Overseer.
...
You do not touch the Forge's internals (`E:\esoteric-path-core`) — that is the Forge Architect's.
