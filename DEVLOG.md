...
brand-font cardinality, live arrangement fixture, portal-model invariants, and
`assert-control.ps1` hygiene checks.

The armed app is
`D:\_EsotericOS\app\EsotericOS-unified-desktop-single-page-admin-bt-isolation.exe`
...
`D:\_EsotericOS\backups\unified-desktop-20260822-004622`. The app task is still
Highest/current-user/interactive with one 30-second logon trigger and no Run
fallback; HKCU Winlogon now names the frozen shell while HKLM remains
